...
public class GetParties extends AsyncTask<Void, Void, ArrayList<Party>> {
    ...
    private ArrayList<GetItemResult> getFriendInfo(){
        ...
        for (Friend friend : AccountManager.getAddedFriends()) {
            ...
            Log.i("PARTIES", "Completed Grabbing User (" + friend.getId() + ")'s Information");
    ...
    private ArrayList<Party> getPartyInfo(ArrayList<String> partyIDs){
        ...
        for(String partyID : partyIDs){
            GetDatabaseItem getParty = new GetDatabaseItem(partyID, Constants.PARTY_DATABASE);
            if (partyID.trim() == "")
                continue; // Skip blank ID's
            Log.i("PARTIES", "Getting party info for " + partyID);
            ...
            parties.add(party);
            Log.i("PARTIES", "Added Party: " + partyLocation + " " + partyName);
        }
        return parties;
    }
